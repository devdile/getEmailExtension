...
function Dashboard() {
  ...
  const findEmails = async (values) => {
    ...
    if (values.firstname != "" && values.lastname != "" && values.website == "")
      isEmail = userData.filter(
        (x) =>
          x.firstname === values.firstname && x.lastname === values.lastname
      );
    ...
    <>
      ...
      <header className="header-sec">
        <section className="top_sec text-center py-2">
          <p className="mb-0">
            Click here to install our New{" "}
            <a href="#/" className="green_clr">
        ...
        <nav className="navbar navbar-expand-lg navbar-light nav_menu py-3">
          <div className="container max-w">
            <a className="navbar-brand order-lg-0 order-2" href="#">
              <img className="mx-auto" src={logo1} alt="Logo" />
            </a>
            <button
              className="navbar-toggler order-lg-0 order-1"
              type="button"
            ...
            <div className="dropdown order-lg-0 order-3">
              ...
              <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                <li>
                  <div className="text-center logout-link" onClick={logout}>
                    Logout
                  </div>
                </li>
              </ul>
      ...
      <section className="form_sec">
        <Formik
          initialValues={{ firstname: "", lastname: "", website: "" }}
        ...
        >
          <Form className="d-md-flex justify-content-between align-items-center text-center">
            ...
            <button
              type="submit"
              className="d-inline-flex justify-content-center align-items-center btn btn_lg primary_bg custom-btn"
            >
              Find Email
            </button>
          </Form>
          ...
          <div className="d-flex align-items-center">
            <form className="overflow-hidden w-100 position-relative">
              <input
                ...
                onChange={(e) => keyupHandle(e)}
                className="w-100 border-0 outline-none shadow-none h-100"
              />
              <button type="submit">
                <img src={search} />
              </button>
